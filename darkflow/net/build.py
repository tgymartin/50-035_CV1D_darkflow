...
class TFNet(object):
	...
	def __init__(self, FLAGS, darknet = None):
		...
		if darknet is None:	
			...
			self.FLAGS.transfer = 0 if self.FLAGS.transfer is None else self.FLAGS.transfer
			self.ntrain = len(darknet.layers)-self.FLAGS.transfer
			# print("self.FLAGS.transfer = {}".format(self.FLAGS.transfer))
